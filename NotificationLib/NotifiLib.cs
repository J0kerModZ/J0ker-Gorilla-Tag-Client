...
namespace J0kersClient.NotificationLib
{
    // All creds go to lars: https://github.com/larsl2005/GTAG-NotificationLib
    ...
    public class NotifiLib : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            Logger.LogInfo($"Client NotificationLib is loaded!");
        ...
        private static void Init()
        {
            ...
            Testtext.font = GameObject.Find("motd").GetComponent<Text>().font;
        ...
        public static void SendNotification(string NotificationText)
        {
            if (IsEnabled)
            {
                if (NotifiText.text.Contains(NotificationText))
                {
                    return;
                }
